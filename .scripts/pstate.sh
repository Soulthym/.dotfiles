#!/bin/bash
#	Source:
#	https://github.com/jsalatas/plasma-pstate/tree/master/gr.ictpro.jsalatas.plasma.pstate/contents/code
#	author: salatas
#	License: GNU GPL V2 https://github.com/jsalatas/plasma-pstate/blob/master/LICENSE.md
#	modified: soulthym
